...
/*	// -- updated 2003-10-16
	...
	{ 0x0001, 0x0001,   "Astra Satellite Network 19,2�E | Soci�t� Europ�enne des Satellites" },
	{ 0x0002, 0x0002,   "Astra Satellite Network 28,2�E | Soci�t� Europ�enne des Satellites" },
	{ 0x0003, 0x0019,   "Astra | Soci�t� Europ�enne des Satellites" },
	{ 0x001A, 0x001A,   "Quiero Televisi�n | Quiero Televisi�n" },
	{ 0x001B, 0x001B,   "RAI | RAI" },
	{ 0x001F, 0x001F,   "Europe Online Networks (EON) | Europe Online Networks S.A" },
	{ 0x0020, 0x0020,   "ASTRA | Soci�t� Europ�enne des Satellites" },
	...
	{ 0x00B0, 0x00B3,   "TPS | La T�l�vision Par Satellite" },
	...
	{ 0xF010, 0xF010,   "Telef�nica Cable | Telef�nica Cable SA" },
	...
	{ 0xFBFE, 0xFBFE,   "TPS | La T�l�vision Par Satellite" },
	{ 0xFBFF, 0xFBFF,   "Sky Italia | Sky Italia Spa." },
	{ 0xFC10, 0xFC10,   "Rh�ne Vision Cable | Rh�ne Vision Cable" },
...
/*	// { Private Data Value, Private Data Value // Organisation" },
	...
	{ 0x0000000F, 0x0000000F,   "Quiero Televisi�n �" },
	{ 0x00000010, 0x00000010,   "La T�l�vision Par Satellite (TPS)" },
	...
	{ 0x0000001A, 0x0000001A,   "T�l�diffusion de France (TDF)" },
	...
	{ 0x00001000, 0x00001000,   "La T�l�vision Par Satellite (TPS�)" },
	...
	{ 0x00600000, 0x00600000,   "Rh�ne Vision Cable" },
	...
	{ 0x56444700, 0x56444700,   "V�a Digital" },
...
/*	// -- updated 2003-10-16
	...
	{ 0x0083, 0x0083,   "Dijital Yay�n Pazarlama ve Ticaret A.�. | 902 | Dijital Yay�n Pazarlama ve Ticaret A.ޠ." },
	...
	{ 0x2100, 0x212f,   "TSA | 902 | Telef�nica Servicios Audiovisuales" },
	{ 0x2130, 0x2130,   "Galaxis | 905 | Galaxis Technology AG �" },
	{ 0x3000, 0x300f,   "TPS | 902 | La T�l�vision Par Satellite" },
